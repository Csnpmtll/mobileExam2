...
class Login extends Component {
    ...
    responseFacebook = (res) => {
        var data = {
            email: res.email,
            password: "" // เวลา login เราจะไม่ใช้ password เพราะเราขอสิทธิของข้อมูลมาแล้ว
        }
                                ...
                                <div class="column is-two-fifths">
                                    <div class="box">
                                        <div class="media-content">
                                            ...
                                            <div class="field">
                                                <div class="control">
                                                    <input class="input is-large" value={this.state.email} type="email" placeholder="Email" onChange={this.handleChangeEmail} ></input>
                                                </div>
                                            </div>
                                            <div class="field">
                                                <div class="control">
                                                    <input class="input is-large" value={this.state.password} type="password" placeholder="Password" onChange={this.handleChangePassword} ></input>
                                                </div>
                                            </div>
                                            <div class="field">
                                                <div class="control">
                                                    <button class="button is-fullwidth is-primary is-large" onClick={this.onClick}>Log In</button>
                                                </div>
                                            </div>
                                            <span>
                                                <FacebookLogin
